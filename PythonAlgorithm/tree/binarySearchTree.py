...
class BinarySearchTree:
    ...
    '''
    One important problem with our implementation of insert is that duplicate keys are not kandled properly. As our tree is implemented a duplicate key will create a new node with the same key value in the right sub-tree of the node having the original key.
    '''
...
'''
    ...
    def rotateRight(self, rotRoot):
        ...
        if rotRoot.isRoot():
            ...
            # TODO: Get the new balance factors
